...
LOCAL_FILE=wanxiang-lts-zh-hans.gram

if [[ -e  ${LOCAL_FILE} ]]; then
    rm -fr ${LOCAL_FILE}
fi

curl -L -o ${LOCAL_FILE} https://github.com/amzxyz/RIME-LMDG/releases/download/LTS/wanxiang-lts-zh-hans.gram

cat > rime_frost.custom.yaml.ldmg <<EOF
